 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function NT(n){return vr(n=Ve(n,st)),new QE(n,e=>Qs(n,e))}(function(e,t=!0){(function(s){Tn=s})(yn),cn(new $t("firestore",(r,{instanceIdentifier:s,options:o})=>{const a=r.getProvider("app").getImmediate(),u=new st(new zg(r.getProvider("auth-internal")),new Gg(a,r.getProvider("app-check-internal")),function(d,p){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new N(S.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new or(d.options.projectId,p)}(a,s),a);return o={useFetchStreams:t,...o},u._setSettings(o),u},"PUBLIC").setMultipleInstances(!0)),Tt(Oc,Mc,e),Tt(Oc,Mc,"esm2020")})();export{iT as $,kT as A,TT as B,$t as C,IT as D,vT as E,it as F,pt as G,CT as H,ST as I,RT as J,PT as K,wT as L,VT as M,bT as N,oo as O,$d as P,XE as Q,sc as R,yn as S,tT as T,nT as U,rT as V,oT as W,sT as X,Mu as Y,zd as Z,cn as _,Se as a,q as a0,ef as a1,dr as a2,eT as a3,ZE as a4,_f as a5,sf as a6,uf as a7,JE as a8,aT as a9,Gd as aa,YE as ab,wt as ac,te as b,co as c,Zd as d,tf as e,cT as f,Hu as g,Ep as h,_n as i,gT as j,ET as k,mT as l,lT as m,dT as n,fT as o,Bu as p,hT as q,Tt as r,Sm as s,uT as t,qu as u,pT as v,yT as w,AT as x,NT as y,UE as z};
