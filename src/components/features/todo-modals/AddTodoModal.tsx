...
import RecurringTodoForm from '../recurring/RecurringTodoForm'
import ProjectTemplateManager from '../project/ProjectTemplateManager'
...
const AddTodoModal = ({ isOpen, onClose, initialDate, initialTab = 'todo' }: AddTodoModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-[999] overflow-y-auto">
      ...
      <div className="fixed inset-0 flex items-start justify-center pt-16 px-6 pb-6">
